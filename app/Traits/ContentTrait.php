...
//                "cash_out_min_amount_requested" => "Cashout Amount Must Be Grater Then : ",
                ...
                "face_recognition_configuration" => "Face Recongnition Configuration (Azure Service)",
                "face_recognition_end_point" => "Face Service End Point",
                "face_recognition_subscription_key" => "Face Service Subscription Key",
                "face_recognition_for_user_register" => "Face Recongnition For User Register",
                "face_recognition_for_driver_register" => "Face Recongnition For Driver Register",
                "face_recognition_for_driver_online_offline" => "Face Recongnition For Driver Online Offline",
                "capture_image_for_face_recognition" => "Please capture image for face recognition",
                "captured_image_not_matched_with_registered_image" => "Captured image not matched with registered image, Please try again",
                "invalid_image_captured" => "Invalid image captured, Please try again.",
            ],
            'all_in_one'=> array(
                "driver"=>"Driver",
                "drivers"=>"Drivers",
        ...
        $module_string = $language_strings[$string_group] ?? $language_strings['all_in_one'];
        $common_string = $language_strings['common'];
        return array_merge($common_string,$module_string);
    }
