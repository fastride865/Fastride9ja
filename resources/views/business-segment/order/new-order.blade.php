                    ...
                    <table id="customDataTable" class="display nowrap table table-hover table-stripedw-full" style="width:100%">
                        ...
                        @foreach($arr_orders as $order)
                            ...
                            <tr>
                                ...
                                <td>
                                    @lang("$string_file.at") {!! date(getDateTimeFormat($order->Merchant->datetime_format,3),$order->order_timestamp) !!}
                                    <br>
                                    {!! date(getDateTimeFormat($order->Merchant->datetime_format,2),$order->order_timestamp) !!}
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    $expire_time = strtotime("$expire_minute minutes", $order->order_timestamp);
                                    @endphp
                                    @lang("$string_file.at") {!! date(getDateTimeFormat($order->Merchant->datetime_format,3),$expire_time) !!}
                                    <br>
                                    {!! date(getDateTimeFormat($order->Merchant->datetime_format,2),$expire_time) !!}
                                </td>
                                <td>
