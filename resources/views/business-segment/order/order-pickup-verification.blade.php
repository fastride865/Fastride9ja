                        ...
                        @foreach($arr_orders as $order)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{trans("$string_file.tip_amount").': '. (!empty($order->tip_amount) ? $order->tip_amount : 0.0) }} <br>
                                ...
                                <td>
                                    <a data-original-title="" data-target="#pickup_otp_verify" data-toggle="modal"
                                       ...
                                       class="btn btn-sm btn-success menu-icon btn_money action_btn pickup_otp_verify">
                                        <span class="fa fa-motorcycle" title="@lang("$string_file.order_pickup_verification")"></span>
                                    </a>
                                    <a target="_blank" title="@lang("$string_file.order_details")"
                                       href="{{route('business-segment.order.detail',$order->id)}}"
                                    ...
                                    <a target="_blank" title="@lang("$string_file.cancel")"
                                       href="{{route('business-segment.order-cancel',$order->id)}}"
                                       class="btn btn-sm btn-warning menu-icon btn_eye action_btn"><span
                                                class="fa fa-eye-slash"></span>
                                    </a>
                                    @if($order->reassign !=1)
                                    <a target="_blank" title=""
                                       href="{{route('business-segment.order.reassign',$order->id)}}" class="btn btn-sm btn-info menu-icon btn_money action_btn">
    ...
    <div class="modal fade text-left" id="pickup_otp_verify" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('business-segment.order.pickup.verify') }}" method="post">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="number" name="otp" placeholder="Enter Driver App @if($order_id_verification == 1) OrderId @else OTP @endif"
