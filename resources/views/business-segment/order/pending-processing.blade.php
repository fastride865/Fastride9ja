            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title"><i class="fa-user" aria-hidden="true"></i>
                        @lang("$string_file.pending_processing_orders")
                    </h3>
                </header>
...
{{--                                    @if($order->order_status == 7)--}}
                                        <a target="_blank" title=""
                                           href="{{route('business-segment.process-order',$order->id)}}"
                                           class="btn btn-sm btn-info menu-icon btn_money action_btn">
                                            <span class="fa fa-spinner" title="@lang("$string_file.process_order")"></span>
                                        </a>
{{--                                    @endif--}}
