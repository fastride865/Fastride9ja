            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    ...
                    @if(isset($booking->OneSignalLog) && !empty($booking->OneSignalLog))
                        ...
                        @endphp
                        <b>OneSignal Summary =></b> @lang('admin.request_sent') : <b>{!! $booking->OneSignalLog->total_request_sent !!} &nbsp; &nbsp;</b> @lang('admin.total_success') : &nbsp;&nbsp;<b>{!! !empty($arr_success_player_id) ? count($arr_success_player_id) : 0 !!} &nbsp;&nbsp;</b> @lang('admin.total_failed') :<b> &nbsp;&nbsp;{!! !empty($arr_failed_player_id) ? count($arr_failed_player_id) : 0 !!}</b>
                    @endif
                    <table id="customDataTable" class="display nowrap table table-hover table-stripedw-full" style="width:100%">
                        ...
                        <tr>
                            ...
                            <th>@lang('admin.pickup_distance')</th>
                            <th>@lang('admin.onesignal_request')</th>
