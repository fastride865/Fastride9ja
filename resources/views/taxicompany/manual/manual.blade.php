                ...
                <div class="panel-body container-fluid">
                    <form method="POST" class="steps-validation wizard-notification" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                <label class="form-control-label" for="ride_radius_driver_taxi_company">@lang("$string_file.enter_radius") ( @lang("$string_file.in_km") )
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="number" class="form-control" id="ride_radius_driver_taxi_company" name="ride_radius" required="" value="0.1"
...
@section('js')
    ...
    <script>
        ...
        $(document).on('change',"#ride_radius_driver_taxi_company,#ride_radius_manual_driver,#driver_marker",function() {
            getMapDrivers();
        });
        ...
        function validation() {
            ...
            if (driver_request == 1 && document.getElementById('ride_radius_driver_taxi_company').value == "") {
        ...
        $("#ride_radius_driver_taxi_company").blur(function () {
            ...
            if (pickup_latitude == "" && drop_latitude == "") {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "{{route('taxicompany.checkDriver')}}",
                    data: {
        ...
        function checkService() {
            ...
            if (val !== "") {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "<?php echo route('taxicompany.price.card.service.config') ?>",
                    data: {
