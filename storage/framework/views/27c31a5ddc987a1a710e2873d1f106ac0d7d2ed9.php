        ...
        <div class="page-content">
            ...
            <div class="panel panel-bordered">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title"><i class="fa-truck" aria-hidden="true"></i> <?php echo app('translator')->get("$string_file.manual_dispatch"); ?>
                    </h3>
                </div>
                <div class="panel-body container-fluid">
                    <form method="POST" class="steps-validation wizard-notification" enctype="multipart/form-data"
                          action="<?php echo e(route('merchant.book.manual.dispach')); ?>" onsubmit="return validation()">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-6">
                                <h5><i class="wb-user"></i> <?php echo app('translator')->get("$string_file.user_details"); ?></h5>
                                <hr>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select class="form-control form-control" id="manual_user_type"
                                                ...
                                                <option value="2" selected><?php echo app('translator')->get("$string_file.registered_user"); ?></option>
                                                <option value="1"><?php echo app('translator')->get("$string_file.new_user"); ?></option>
                                                <?php if(Auth::user('merchant')->can('view_corporate') && $baseConfig->corporate_admin == 1): ?>
                                                    <option value="3"><?php echo app('translator')->get("$string_file.corporate_user"); ?>
                                                    </option>
                                                <?php endif; ?>
                                            </select>
                                        </div>
                                        ...
                                        <?php if($errors->has('user_id')): ?>
                                            <label class="text-danger"><?php echo e($errors->first('user_id')); ?></label>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select class="form-control form-control" name="country"
                                                ...
                                                <option value=""><?php echo app('translator')->get("$string_file.country_code"); ?>
                                                </option>
                                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option data-min="<?php echo e($country->minNumPhone); ?>"
                                                            data-max="<?php echo e($country->maxNumPhone); ?>"
                                                            data-country-code="<?php echo e($country->country_code); ?>"
                                                            value="<?php echo e($country->id); ?>"
                                                            data-phone="<?php echo e($country->phonecode); ?>">(<?php echo e($country->phonecode); ?>) <?php echo e(isset($country->LanguageCountrySingle->name) ? $country->LanguageCountrySingle->name : $country->LanguageCountryAny->name); ?>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group pull-right" id="check_user_details_div">
                                            <button type="button" class="btn btn-primary"
                                                    id="check_user_details"><?php echo app('translator')->get("$string_file.search"); ?></button>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 custom-hidden" id="first_name_new_div">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="new_user_first_name"
                                                   ...
                                                   placeholder="<?php echo app('translator')->get("$string_file.first_name"); ?>" autocomplete="off"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6 custom-hidden" id="last_name_new_div">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="new_user_last_name"
                                                   ...
                                                   placeholder="<?php echo app('translator')->get("$string_file.last_name"); ?>" autocomplete="off"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 custom-hidden" id="corporate_div">
                                        <div class="form-group">
                                            <select class="form-control" name="corporate_id"
                                                    id="corporate_id">
                                                <option value="">--<?php echo app('translator')->get("$string_file.select_corporate"); ?>--</option>
                                    ...
                                    <div class="col-md-6 custom-hidden" id="email_new_div">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="new_user_email"
                                                   name="new_user_email"
                                                   placeholder="<?php echo app('translator')->get("$string_file.email"); ?>" autocomplete="off"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 custom-hidden" id="new_user_details_div">
                                        <div class="form-group pull-right">
                                            <button type="button" class="btn btn-primary"
                                                    id="new_user_details"><?php echo app('translator')->get("$string_file.register_user"); ?></button>
                                        </div>
                                    </div>
                                    <div class="col-md-3 custom-hidden" id="full_details_div">
                                        <div class="form-group pull-right">
                                            <a target="_blank" id="full_details" class="btn btn-primary" disabled>
                                                ...
                                                <?php echo app('translator')->get("$string_file.full_details"); ?>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <h5><i class="fa fa-dollar"></i> <?php echo app('translator')->get("$string_file.price_for_ride"); ?></h5>
                                <hr>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select class="form-control" name="price_for_ride" id="price_for_ride">
                                                ...
                                                <option value="1"><?php echo app('translator')->get("$string_file.from_price_card"); ?></option>
                                                <option value="2"><?php echo app('translator')->get("$string_file.fix_amount"); ?></option>
                                                <option value="3"><?php echo app('translator')->get("$string_file.maximum_amount"); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6 custom-hidden" id="price_ride_value_div">
                                        <div class="form-group">
                                            <input class="form-control" type="text" id="price_for_ride_value" name="price_for_ride_value" placeholder="<?php echo app('translator')->get("$string_file.enter_amount"); ?>">
                                        </div>
                                    </div>
                                </div>
                                <h5><i class="wb-book"></i> <?php echo app('translator')->get("$string_file.ride_details"); ?></h5>
                                <hr>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="pickup_location" name="pickup_location"
                                                   placeholder="<?php echo app('translator')->get("$string_file.pickup_location"); ?>" autocomplete="off" onkeyup="resetPromoCode();getPickupLoction();" />
                                            ...
                                            <?php if($errors->has('pickup_location')): ?>
                                                <label class="text-danger"><?php echo e($errors->first('pickup_location')); ?></label>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="input-group form-group after-add-more" id="drop_location_div">
                                            <input type="text" class="form-control"
                                                   ...
                                                   placeholder="<?php echo app('translator')->get("$string_file.drop_off_location"); ?>" autocomplete="off" onkeyup="resetPromoCode();getDropLoction();">
                                            <div class="input-group-btn">
                                                <button style="display: none" class="btn btn-success add-more" type="button" id="add_loc">
                                                    <i class="wb-plus"></i><?php echo app('translator')->get("$string_file.add"); ?></button>
                                            </div>
                                            <?php if($errors->has('drop_location')): ?>
                                                <label class="text-danger"><?php echo e($errors->first('drop_location')); ?></label>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="form-control-label"><?php echo app('translator')->get("$string_file.ride_type"); ?></label>
                                            <span class="text-danger">*</span>
                                            <div>
                                                <div class="radio-custom radio-default radio-inline">
                                                    <input type="radio" id="radio1" name="booking_type" onclick="RideType(this.value)" value="1" />
                                                    <label for="radio1"><?php echo app('translator')->get("$string_file.ride_now"); ?></label>
                                                </div>
                                                <div class="radio-custom radio-default radio-inline">
                                                    <input type="radio" id="radio2" name="booking_type" onclick="RideType(this.value)" value="2" />
                                                    <label for="radio2"><?php echo app('translator')->get("$string_file.ride"); ?>  <?php echo app('translator')->get("$string_file.later"); ?> </label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 custom-hidden" id="start-div">
                                        <div class="form-group">
                                            <label class="form-control-label" for="datepicker"><?php echo app('translator')->get("$string_file.start"); ?>  <?php echo app('translator')->get("$string_file.date"); ?>
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control customDatePicker1" id="datepicker" name="date"
                                                       placeholder="<?php echo app('translator')->get("$string_file.start"); ?>  <?php echo app('translator')->get("$string_file.date"); ?> " autocomplete="off" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 custom-hidden" id="end-div">
                                        <div class="form-group">
                                            <label class="form-control-label" for="inputtime"><?php echo app('translator')->get("$string_file.start"); ?>  <?php echo app('translator')->get("$string_file.time"); ?>
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                ...
                                                <input type="text" class="timepicker form-control" data-plugin="clockpicker" data-autoclose="true"
                                                       id="time" name="time" placeholder="<?php echo app('translator')->get("$string_file.start"); ?>  <?php echo app('translator')->get("$string_file.time"); ?> " autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 custom-hidden" id="retrun_date_div">
                                        <div class="form-group">
                                            <label class="form-control-label" for="inputdatepicker"><?php echo app('translator')->get("$string_file.return_date"); ?>
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                    ...
                                    <div class="col-md-6 custom-hidden" id="retrun_time_div">
                                        <div class="form-group">
                                            <label class="form-control-label" for="time"><?php echo app('translator')->get("$string_file.return_time"); ?>
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                            <span class="input-group-text">
                                              <i class="wb-time" aria-hidden="true"></i>
                                                ...
                                                <input type="text" class="timepicker form-control" data-plugin="clockpicker" data-autoclose="true"
                                                       id="time" name="retrun_time" placeholder="<?php echo app('translator')->get("$string_file.return_time"); ?> " autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if($errors->has('vehicle_type')): ?>
                                                <label class="text-danger"><?php echo e($errors->first('vehicle_type')); ?></label>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select class="form-control form-control" name="service"
                                                ...
                                                <option value="">--<?php echo app('translator')->get("$string_file.service_area"); ?> --
                                                </option>
                                            </select>
                                            <?php if($errors->has('service')): ?>
                                                <label class="text-danger"><?php echo e($errors->first('service')); ?></label>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="col-md-6 custom-hidden" id="outstation_type">
                                        <div class="form-group">
                                            <select class="form-control form-control" name="outstation_type_val"
                                                ...
                                                <option value=""><?php echo app('translator')->get("$string_file.fare_type"); ?> </option>
                                                <option value="1"><?php echo app('translator')->get("$string_file.round_trip_only"); ?></option>
                                                <option value="2"><?php echo app('translator')->get("$string_file.one_way_round_trip"); ?></option>
                                            </select>
                                            <?php if($errors->has('outstation_type_val')): ?>
                                                <label class="text-danger"><?php echo e($errors->first('outstation_type_val')); ?></label>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6 custom-hidden" id="package_id">
                                        <div class="form-group">
                                            <select class="form-control form-control" name="package"
                                                    id="package">
                                                <option value="">--<?php echo app('translator')->get("$string_file.select_package"); ?>--</option>
                                            </select>
                                            <?php if($errors->has('package')): ?>
                                                <label class="text-danger"><?php echo e($errors->first('package')); ?></label>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select class="form-control form-control" name="payment_method_id"
                                                ...
                                                <option value="">--<?php echo app('translator')->get("$string_file.payment_method"); ?>--</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select class="form-control form-control" name="promo_code"
                                                    id="promo_code">
                                                <option value="">--<?php echo app('translator')->get("$string_file.promo_code"); ?>--</option>
                                            </select>
                                        </div>
                                    </div>
                                    <?php if($bookingConfig->additional_note == 1): ?>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <textarea class="form-control" id="placeTextarea" rows="3" name="note" placeholder="<?php echo app('translator')->get("$string_file.additional_notes"); ?>"></textarea>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="form-control-label" for="driver_marker"><?php echo app('translator')->get("$string_file.driver_availability"); ?>:
                                                <span class="text-danger">*</span>
                                            </label>
                                            <select class="form-control form-control-sm" name="type" id="driver_marker">
                                                <option value="1"><?php echo app('translator')->get("$string_file.all"); ?></option>
                                                <option value="2"><?php echo app('translator')->get("$string_file.available"); ?></option>
                                                <option value="3"><?php echo app('translator')->get("$string_file.enroute_pickup"); ?></option>
                                                <option value="4"><?php echo app('translator')->get("$string_file.reached_pickup"); ?></option>
                                                <option value="5"><?php echo app('translator')->get("$string_file.journey_started"); ?></option>
                                                <option value="6"><?php echo app('translator')->get("$string_file.offline"); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <h5 class="form-section col-md-12" style="color: black;"><i
                                    class="fa fa-taxi"></i> <?php echo app('translator')->get("$string_file.assign_ride"); ?>
                        </h5>
                        <hr>
                        <div class="row">
                            <?php if($config->gender == 1): ?>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-control-label" for="driver_gender"><?php echo app('translator')->get("$string_file.gender"); ?>
                                            <span class="text-danger">*</span>
                                        </label>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <div>
                                    <div class="radio-custom radio-default radio-inline">
                                        ...
                                        <label for="all_driver_booking"> <?php echo app('translator')->get("$string_file.send_booking_to_all_drivers"); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 form-group">
                                <label class="form-control-label" for="ride_radius_driver"><?php echo app('translator')->get("$string_file.enter_radius"); ?> ( <?php echo app('translator')->get("$string_file.in_km"); ?> )
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="number" class="form-control" id="ride_radius_driver" name="ride_radius" required="" value="0.1"
                                       placeholder="<?php echo app('translator')->get("$string_file.enter"); ?> <?php echo app('translator')->get("$string_file.number"); ?>" min="0">
                                <label class="text-danger"><b id="number_of_drivers">0</b> <?php echo app('translator')->get("$string_file.drivers"); ?> (<?php echo app('translator')->get("$string_file.online"); ?> <?php echo app('translator')->get("$string_file.and_symbol"); ?> <?php echo app('translator')->get("$string_file.free"); ?> )</label>
                            </div>
                        </div>
                        <div class="row">
                            <h4 style="text-align:center; margin:10px auto; font-weight:bold; width:100%;"><?php echo app('translator')->get("$string_file.or"); ?></h4>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="radio-custom radio-default radio-inline">
                                            ...
                                            <label for="manually_driver"> <?php echo app('translator')->get("$string_file.select_driver_manually"); ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="ride_radius_manual_driver"><?php echo app('translator')->get("$string_file.enter_radius"); ?> ( <?php echo app('translator')->get("$string_file.in_km"); ?> )</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="driver_id"><?php echo app('translator')->get("$string_file.driver"); ?>
                                        <span class="text-danger">*</span>
                                    </label>
                                    <select class="form-control form-control" name="driver_id"
                                            id="driver_id">
                                        <option value="">--<?php echo app('translator')->get("$string_file.driver"); ?>--</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-actions float-right" style="margin-bottom: 1%">
                            <button type="button" id="resetForm" class="btn btn-warning mr-1">
                                <i class="fas fa-times"></i> <?php echo app('translator')->get("$string_file.reset"); ?>
                            </button>
                            <button type="submit" id="manualDispatch" class="btn btn-primary">
                                <i class="fa fa-check-circle"></i> <?php echo app('translator')->get("$string_file.book"); ?>
                            </button>
                        </div>
                    </form>
                    ...
                    <div class="copy custom-hidden">
                        <div class="input-group" style="margin-top:10px; margin-bottom:10px">
                            <input type="text" name="multiple_destination[]" class="form-control blur" id="drop_loc"
                                   ...
                                   placeholder="<?php echo app('translator')->get('admin.message577'); ?>">
                            ...
                            <div class="input-group-btn">
                                <button class="btn btn-danger remove" type="button"><i
                                            class="glyphicon glyphicon-remove"></i> <?php echo app('translator')->get("$string_file.remove"); ?>
                                </button>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        var restric_config = "<?php echo e($config->restrict_country_wise_searching); ?>";
        var options = {};
        // console.log(options);
        ...
        $('#time').on('change',function () {
            ...
            if((selected <= current_date) && (total_time_diff < 0)){
                sweetalert("<?php echo app('translator')->get("$string_file.past_time_error"); ?>");
                $("#time").val('');
                return false;
            }
            // console.log($('#time').val());
        ...
        function getPickupLoction(){
            ...
            if($("#pickup_location").val().length > <?php echo e($bookingConfig->autocomplete_start); ?>)
            {
                ...
                start.addListener('place_changed', function () {
                    ...
                    var merchant_id = <?php echo e($config->merchant_id); ?>;
                    var token = $('[name="_token"]').val();
        ...
        function getDropLoction(){
            ...
            if($("#drop_location").val().length > <?php echo e($bookingConfig->autocomplete_start); ?>){
        ...
        function getMultiDropLoction(data){
            if(data.value.length > <?php echo e($bookingConfig->autocomplete_start); ?>){
        ...
        function validation() {
            ...
            if (country == "") {
                sweetalert("<?php echo app('translator')->get("$string_file.select_country"); ?>");
                return false;
            }
            if (user == "") {
                sweetalert("<?php echo app('translator')->get("$string_file.user_not_found"); ?>");
                return false;
            }
            if (manual_area == "") {
                sweetalert("<?php echo app('translator')->get("$string_file.select_service_area"); ?>");
                return false;
            }
            if (service == "") {
                sweetalert("<?php echo app('translator')->get("$string_file.select_service_type"); ?>");
                return false;
            }
            if (vehicle_type == "") {
                sweetalert("<?php echo app('translator')->get("$string_file.select_vehicle_type"); ?>");
                return false;
            }
            if ([2, 3].includes(service) && package == "") {
                sweetalert("<?php echo app('translator')->get("$string_file.select_package"); ?>");
                return false;
            }
            if (document.getElementById("radio1").checked != true && document.getElementById('radio2').checked != true) {
                sweetalert("<?php echo app('translator')->get("$string_file.select_ride_type"); ?>");
                return false;
            }
            if (pickup_location == "") {
                sweetalert("<?php echo app('translator')->get("$string_file.enter_pickup_location"); ?>");
                return false;
            }
            if (payment_method_id == "") {
                sweetalert("<?php echo app('translator')->get("$string_file.select_payment_method"); ?>");
                return false;
            }
            if (driver_request == 1 && document.getElementById('ride_radius_driver').value == "") {
                sweetalert("<?php echo app('translator')->get("$string_file.enter_request_radius"); ?>");
                return false;

            }
            if (driver_request == 3 && document.getElementById('driver_id').value == "") {
                sweetalert("<?php echo app('translator')->get("$string_file.select_driver"); ?>");
                return false;
            }
        ...
        function getService() {
            ...
            if (area_id != "" && vehicle_type_id != '') {
                ...
                alert('<?php echo trans("$string_file.select_segment"); ?>');
        ...
        function checkService() {
            ...
            $("#package").html("<option value=''><?php echo app('translator')->get("$string_file.select_package"); ?></option>");
            if (val !== "") {
                var token = $('[name="_token"]').val();
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        merchant_id: "<?php echo e($bookingConfig->merchant_id); ?>"
                    },
                    success: function (data) {
                        // console.log(data);
                        if (additional_support == 1 || additional_support == 2) {
                            ...
                            if (additional_support == "1") {
                                ...
                                <!--$("#newText").text("<?php echo app('translator')->get('admin.message542'); ?>");-->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v1/resources/views/merchant/manual/manual.blade.php ENDPATH**/ ?>