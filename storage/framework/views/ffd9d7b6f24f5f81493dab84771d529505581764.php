            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    <div class="panel-actions">
                        ...
                        <div class="btn-group float-right">
                            <a href="<?php echo e(route('outstationpackage.index')); ?>">
                    ...
                    <h3 class="panel-title"><i class="icon wb-plus" aria-hidden="true"></i>
                        <?php echo app('translator')->get("$string_file.add_package_details"); ?>
                ...
                <div class="panel-body container-fluid">
                    <form method="POST" class="steps-validation wizard-notification"
                          ...
                          action="<?php echo e(route('outstationpackage.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <fieldset>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="city"><?php echo app('translator')->get("$string_file.city_name"); ?> <span
                                                    class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="city" name="city"
                                               placeholder="" required>
                                        <?php if($errors->has('city')): ?>
                                            <label class="text-danger"><?php echo e($errors->first('city')); ?></label>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="city"><?php echo app('translator')->get("$string_file.service_type"); ?><span
                                                    class="text-danger">*</span></label>
                                        <?php echo Form::select('service_type_id',add_blank_option($arr_services,trans("$string_file.select")),old('service_type_id'),['id'=>'outstation_service_type','class'=>'form-control','required'=>true]); ?>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <label for="emailAddress5">
                                            <?php echo app('translator')->get("$string_file.draw_area"); ?>
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v1/resources/views/merchant/outstation/create.blade.php ENDPATH**/ ?>