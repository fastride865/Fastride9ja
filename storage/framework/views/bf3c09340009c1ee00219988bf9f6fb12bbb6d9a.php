            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title"><i class="fa-user" aria-hidden="true"></i>
                        <?php echo app('translator')->get("$string_file.upcoming_orders"); ?>
                    </h3>
                </header>
                        ...
                        <?php $__currentLoopData = $arr_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <?php if(isset($order->Merchant->datetime_format)): ?>
                                        <?php echo app('translator')->get("$string_file.at"); ?> <?php echo e(date(getDateTimeFormat($order->Merchant->datetime_format,3),$expire_time)); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('business-segment.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v1/resources/views/business-segment/order/upcoming-order.blade.php ENDPATH**/ ?>