            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title"><i class="fa-user" aria-hidden="true"></i>
                        <?php echo app('translator')->get("$string_file.order_pickup_verification"); ?>
                    </h3>
                </header>
                        ...
                        <?php $__currentLoopData = $arr_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php echo e(trans("$string_file.tip_amount").': '. (!empty($order->tip_amount) ? $order->tip_amount : 0.0)); ?> <br>
                                ...
                                <td>
                                    <a data-original-title="" data-target="#pickup_otp_verify" data-toggle="modal"
                                       data-id="<?php echo e($order->id); ?>" data-placement="top" data-backdrop="static" data-keyboard="false"
                                       class="btn btn-sm btn-success menu-icon btn_money action_btn pickup_otp_verify">
                                        <span class="fa fa-motorcycle" title="<?php echo app('translator')->get("$string_file.order_pickup_verification"); ?>"></span>
                                    </a>
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('business-segment.order.pickup.verify')); ?>" method="post">
                    ...
                    <div class="modal-body">
                        <label><?php if($order_id_verification == 1): ?> <?php echo app('translator')->get("$string_file.order"); ?> <?php echo app('translator')->get("$string_file.id"); ?> <?php else: ?> <?php echo app('translator')->get("$string_file.otp"); ?> <?php endif; ?></label>
                        <div class="form-group">
                            <input type="number" name="otp" placeholder="Enter Driver App <?php if($order_id_verification == 1): ?> OrderId <?php else: ?> OTP <?php endif; ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('business-segment.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v1/resources/views/business-segment/order/order-pickup-verification.blade.php ENDPATH**/ ?>