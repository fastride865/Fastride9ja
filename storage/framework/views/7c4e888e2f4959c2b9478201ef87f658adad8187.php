            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title"><i class="fa-user" aria-hidden="true"></i>
                        <?php echo app('translator')->get("$string_file.pending_processing_orders"); ?>
                    </h3>
                </header>
                <div class="panel-body container-fluid">
                    ...
                    <table id="customDataTable" class="display nowrap table table-hover table-stripedw-full"
                        ...
                        <?php $__currentLoopData = $arr_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $order_history = array_column(json_decode($order->order_status_history,true),'order_status');?>
                            <?php if(!in_array(9,$order_history)): ?>
                            <?php
                            ...
                            <tr>
                                ...
                                <td>
                                        ...
                                        <a target="_blank" title=""
                                           href="<?php echo e(route('business-segment.process-order',$order->id)); ?>"
                                           class="btn btn-sm btn-info menu-icon btn_money action_btn">
                                            <span class="fa fa-spinner" title="<?php echo app('translator')->get("$string_file.process_order"); ?>"></span>
                                        </a>
...
<?php echo $__env->make('business-segment.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v1/resources/views/business-segment/order/pending-processing.blade.php ENDPATH**/ ?>