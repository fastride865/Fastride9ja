            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title"><i class="fa-user" aria-hidden="true"></i>
                        <?php echo app('translator')->get("$string_file.today_order"); ?>
                    </h3>
                </header>
                <div class="panel-body container-fluid">
                    ...
                    <table id="customDataTable" class="display nowrap table table-hover table-stripedw-full" style="width:100%">
                        ...
                        <tr>
                            ...
                            <th><?php echo app('translator')->get("$string_file.expire_at"); ?></th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                     ...
                                     if($order->order_type == 1) // instant order
                                     {
                                    ...
                                    ?>
                                    <?php echo e(convertTimeToUSERzone($expire_time, $order->CountryArea->timezone,null,$order->Merchant)); ?>
                                ...
                                <td>
                                    <?php if($order_request_receiver == 1): ?>
                                            
                                         <?php if(($order->order_date == date('Y-m-d',strtotime($order->created_at))) || (($order->order_date == date('Y-m-d')) && $current_time_stamp <= $order_time_stamp)): ?>
                                            <a target="_blank" title=""
                                               href="<?php echo e(route('business-segment.order.assign',$order->id)); ?>" class="btn btn-sm btn-info menu-icon btn_money action_btn">
                                                <span class="fa fa-check" title="<?php echo app('translator')->get("$string_file.manual_assign"); ?>"></span>
                                            </a>
                                            <a data-original-title="" data-target="#auto_assign" data-toggle="modal"
                                               data-id="<?php echo e($order->id); ?>" data-placement="top" data-backdrop="static" data-keyboard="false"
                                               class="btn btn-sm btn-success menu-icon btn_money action_btn auto_assign">
                                                <span class="fa fa-send" title="<?php echo app('translator')->get("$string_file.auto_assign"); ?>"></span>
                                            </a>
                                        <?php endif; ?>
                                    <?php elseif($order_request_receiver == 2): ?>
                                        <?php
                                            $diff = strtotime(date('Y-m-d H:i:s')) - $order->order_timestamp;
                                        ?>
                                        <?php if($diff > $booking_config->driver_request_timeout): ?>
                                            <a target="_blank" title=""
                                               href="<?php echo e(route('business-segment.order.assign',$order->id)); ?>" class="btn btn-sm btn-info menu-icon btn_money action_btn">
                                                <span class="fa fa-check" title="<?php echo app('translator')->get("$string_file.manual_assign"); ?>"></span>
                                            </a>
                                    ...
                                    <?php if($order_request_receiver == 1): ?>
                                    <a target="_blank" title="<?php echo app('translator')->get("$string_file.reject"); ?>"
                                       href="<?php echo e(route('business-segment.order-reject',$order->id)); ?>" class="btn btn-sm btn-danger menu-icon btn-edit action_btn"><span class="fa fa-edit"></span>
                                    </a>
                                    <?php endif; ?>
                                </td>
                            </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <label class="modal-title text-text-bold-600" id="myModalLabel33"><b><?php echo app('translator')->get("$string_file.assign_order_to_delivery_candidate"); ?></b></label>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <?php echo Form::open(['name'=>"","url"=>route('business-segment.order.auto-assign')]); ?>

                    <div class="modal-body">
                        <label><?php echo app('translator')->get("$string_file.are_you_sure_assign"); ?></label>
                    ...
                    <div class="modal-footer">
                        <input type="reset" class="btn btn-secondary" data-dismiss="modal" value="<?php echo app('translator')->get("$string_file.no"); ?>">
                        <input type="submit" id="sub" class="btn btn-primary" value="<?php echo app('translator')->get("$string_file.yes"); ?>">
                    </div>
               <?php echo Form::close(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('business-segment.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v1/resources/views/business-segment/order/today-order.blade.php ENDPATH**/ ?>