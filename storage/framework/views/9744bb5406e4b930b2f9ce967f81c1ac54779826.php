                                ...
                                <?php $__currentLoopData = get_config_image('map_icon'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $path): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-md-4">
                                        <input type="radio" name="vehicle_map_image" value="<?php echo e($path); ?>"
                                            ...
                                            <img src="<?php echo e(view_config_image($path)); ?>" class="w-p10" >
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v1/resources/views/merchant/vehicletype/index.blade.php ENDPATH**/ ?>