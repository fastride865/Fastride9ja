                            ...
                            <td style="">
                                <table align="left" style="margin:0;max-width:170px">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <h3><?php echo app('translator')->get("$string_file.user_name"); ?></h3>
                                                <p style="font-size:12px;color:#1d1c1cc4;">
                                                    <?php if($login_type=='EMAIL'): ?>
                                                        <?php echo e($user->email); ?>

                                                    <?php else: ?>
                                                        <?php echo e($user->UserPhone); ?>
                                        ...
                                        <tr>
                                            <td>
                                                <h3><?php echo app('translator')->get("$string_file.registered"); ?>
                                                <?php if($login_type=='EMAIL'): ?>
                                        ...
                                        <tr>
                                            <td>
                                                <h3><?php echo app('translator')->get("$string_file.user_id"); ?></h3>
                                                <p style="font-size:12px;color:#1d1c1cc4;"><?php echo e($user->user_merchant_id); ?></p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
...
<?php /**PATH /home/msprojectsappori/public_html/multi-service-v1/resources/views/mail/user-welcome.blade.php ENDPATH**/ ?>