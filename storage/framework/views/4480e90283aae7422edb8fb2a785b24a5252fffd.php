...
<div class="container content-width" style="background-color: #ffffff;max-width: 700px;min-width:300px;margin: 20px auto;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;">
    ...
    <div class="user-details" style="font-size: 13px; font-weight: 400;text-align: left;padding-left:25px; padding-right:25px;">
        ...
        <p><?php echo e($order->User->first_name.' '.$order->User->last_name); ?>,</p>
        <p><?php echo app('translator')->get("$string_file.mail_content_1"); ?> <?php echo e($order->Merchant->BusinessName); ?>! .<?php echo app('translator')->get("$string_file.mail_content_2"); ?> <?php echo app('translator')->get("$string_file.mail_content_3"); ?></p>
    </div>
                    ...
                    <table align="right" style="margin:0;width:190px;max-width:100%;padding-bottom:10px;">
                        ...
                        <tr>
                            <td style="border-bottom: none;padding:0; text-align: right;">
                                <p style="font-size: 13px; font-weight: 400; margin-bottom: 5px;"><?php echo app('translator')->get("$string_file.f_cap_from"); ?>:</p>
                                <h6 style="font-weight:900;font-size:14px; margin:0;"><?php echo e($order->BusinessSegment->full_name); ?></h6>
                            </td>
                        </tr>
                        </tbody>
                    </table>
        ...
        <table style="margin:0;width: 100%;">
            ...
            <tr>
                ...
                <td style="border-bottom: none;padding:0; text-align: right;">
                    ...
                    <h6 style="font-weight:900;font-size:14px; margin:0;color: #79b33b;"><?php echo app('translator')->get("$string_file.delivered"); ?></h6>
                </td>
            </tr>
            </tbody>
        </table>
                    ...
                    <table align="left" style="margin:0;width:190px;max-width:100%;padding-bottom:10px;">
                        ...
                        <tr>
                            <td style="border-bottom: none; padding:0;">
                                ...
                                <p style="margin:0;font-weight:normal;line-height:1.6"><?php echo e($order->drop_location); ?>
...
</html><?php /**PATH /home/msprojectsappori/public_html/multi-service-v1/resources/views/mail/order-invoice.blade.php ENDPATH**/ ?>