            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title">
                        ...
                        <?php echo app('translator')->get("$string_file.order_earning_statistics_of"); ?> <span class="blue-500"> <?php echo e(is_demo_data($driver->first_name.' '.$driver->last_name,$driver->Merchant)); ?> (<?php echo e(is_demo_data($driver->phoneNumber,$driver->Merchant)); ?>) </span>
                    </h3>
                    <div class="panel-actions">
                        ...
                        <div class="col-xl-3 col-md-3 info-panel">
                            <div class="card card-shadow">
                                <div class="card-block bg-grey-100 p-20">
                                    ...
                                    <div class="content-text text-center mb-0">
                                        <span class="font-size-20 font-weight-100"><?php echo e(isset($business_summary['income']['order_amount']) ? $currency.$business_summary['income']['order_amount'] : 0); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-3 info-panel">
                            <div class="card card-shadow">
                                <div class="card-block bg-grey-100 p-20">
                                    ...
                                    <div class="content-text text-center mb-0">
                                        <span class="font-size-20 font-weight-100"><?php echo e(isset($business_summary['income']['driver_earning']) ? $currency.$business_summary['income']['driver_earning'] : 0); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <?php if(!empty($arr_orders)): ?>
                                            ...
                                            <?php $__currentLoopData = $arr_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo app('translator')->get("$string_file.at"); ?> <?php echo e(date('H:i',strtotime($order->created_at))); ?>,
...
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v1/resources/views/merchant/report/delivery-services/driver.blade.php ENDPATH**/ ?>