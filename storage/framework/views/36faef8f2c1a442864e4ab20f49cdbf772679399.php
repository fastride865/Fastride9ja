...
?>
<?php echo Form::open(['name'=>'','url'=>$search_route,'method'=>'GET','autocomplete'=>false]); ?>
...
<?php echo Form::hidden('driver_id',$driver_id,['class'=>'form-control']); ?>
   ...
   <div class="table_search row">
        ...
        <div class="col-md-2 col-xs-12 form-group active-margin-top">
            <div class="input-group">
                <input type="text" id="" name="booking_id" value="<?php echo e($booking_id); ?>"
                       placeholder="<?php echo app('translator')->get("$string_file.booking_id"); ?>"
                       class="form-control col-md-12 col-xs-12">
            </div>
        </div>
            <?php if($request_from != "booking_earning"): ?>
            <div class="col-md-2 col-xs-12 form-group active-margin-top">
                <div class="input-group">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="start" value="<?php echo e($start); ?>" autocomplete="false" />
            </div>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text">to</span>
                </div>
                <input type="text" class="form-control" name="end" value="<?php echo e($end); ?>" autocomplete="false" />
            </div>
        </div>
    </div>
...
<?php echo Form::close(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v1/resources/views/merchant/handyman-order/booking-search.blade.php ENDPATH**/ ?>