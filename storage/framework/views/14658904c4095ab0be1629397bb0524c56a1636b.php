            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    <div class="panel-actions">
                        ...
                        <?php endif; ?>
                        <a href="<?php echo e(route('outstationpackage.index')); ?>" data-toggle="tooltip">
                            <button type="button" class="btn btn-icon btn-success float-right" style="margin:10px">
                                <i class="wb-reply" title="<?php echo app('translator')->get("$string_file.package"); ?>"></i>
                            </button>
                        </a>
                    </div>
                    <h3 class="panel-title"><i class="wb-edit" aria-hidden="true"></i>
                        <?php echo app('translator')->get("$string_file.edit_package"); ?>  <?php echo e(strtoupper(Config::get('app.locale'))); ?>

                        )</h3>
                </header>
                <div class="panel-body container-fluid">
                    <form method="POST" class="steps-validation wizard-notification" enctype="multipart/form-data"
                          action="<?php echo e(route('outstationpackage.update', $package->id)); ?>"> <?php echo e(method_field('PUT')); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label"
                                           for="firstName3"><?php echo app('translator')->get("$string_file.city_name"); ?>
                                        <span class="text-danger">*</span>
                                    </label>
                                    <input type="text" class="form-control" id="city" name="city"
                                           value="<?php if($package->LanguageSingle): ?> <?php echo e($package->LanguageSingle->city); ?> <?php endif; ?>"
                                           placeholder="" required/>
                                    <!--<input type="hidden" class="form-control " id="lat" name="lat">-->
                                </div>
                                <?php if($errors->has('city')): ?>
                                    <label class="danger"><?php echo e($errors->first('city')); ?></label>
                                <?php endif; ?>
                            </div>
                            <div id="newOpenstreet">
                                <input type="text" class="form-control" id="google_area" name="google_area"
                                       placeholder="<?php echo app('translator')->get("$string_file.search_area"); ?>"/>
                                <input type="hidden" class="form-control" id="lat" name="lat">
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" rows="3" name="description"
                                              placeholder=""><?php if($package->LanguageSingle): ?> <?php echo e($package->LanguageSingle->description); ?> <?php endif; ?></textarea>
                        ...
                        <div class="form-actions d-flex flex-row-reverse p-2">
                            ...
                            <button type="submit" class="btn btn-primary"><i
                                        class="fa fa-check-circle"></i> <?php echo app('translator')->get("$string_file.update"); ?></button>
                            <?php else: ?>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        ...
        var NewJson;
        var polygonArray = [];
        let data = <?php if(!empty($package->area_coordinates)): ?><?php echo $package->area_coordinates; ?><?php else: ?> [{
            "latitude": "28.679632",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('merchant.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/msprojectsappori/public_html/multi-service-v1/resources/views/merchant/outstation/edit.blade.php ENDPATH**/ ?>